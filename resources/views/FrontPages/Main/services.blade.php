        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box iconbox-blue">
                    ...
                    <p>Design and develop high-quality, responsive websites and web applications.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
                ...
                <div class="icon-box iconbox-pink">
                    ...
                    <p>Efficient management and optimization of IT infrastructure and server systems.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
                data-aos-delay="400">
                <div class="icon-box iconbox-red">
                    ...
                    <h4><a href="#">System Designer</a></h4>
                    <p>Design comprehensive system architectures and workflows for optimal performance and scalability.</p>
                </div>
            </div>
        </div>
    </div>
